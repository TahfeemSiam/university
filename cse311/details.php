        ...
        <div class="product_image_preview d-flex justify-content-center">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <?php
                            if(!empty($productImage_2)) {
                                echo "<img style='width:200px' src='./images/$productImage_2' >";
                            }
                        ?>

                        <?php
                            if(!empty($productImage_3)) {
                                echo "<img style='width:200px' src='./images/$productImage_3' >";
                            }
                        ?>
